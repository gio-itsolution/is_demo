...
from my_best_call_manager.utils.datetime_utils import get_now_date
from my_best_call_manager.utils.setting_goals import setting_goals
from my_best_call_manager.utils.api_methods import *
from integration_utils.bitrix24.bitrix_user_auth.main_auth import main_auth


@main_auth(on_cookies=True)
def my_start_find_all_call(request):
    ...
    if request.method == "POST":
        ...
        #         messages.info(request, "Задачи уже создавались сегодня!")
        ...
        task_id_list, possible_calls, users_tasks = setting_goals(but, calls)
        ...
        messages.success(request, "Задачи успешно созданы!")

        return render(request, "create_tasks.html", context={"users_tasks": users_tasks})
